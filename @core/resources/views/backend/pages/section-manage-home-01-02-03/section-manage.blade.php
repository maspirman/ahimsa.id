                    ...
                    <div class="card-body">
                        ...
                        <form action="{{route('admin.homeone.section.manage')}}" method="post" enctype="multipart/form-data">
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-4">
                                    <div class="form-group">
                                        <label for="home_page_client_area_05_section_status"><strong>{{__('Client Section Show/Hide')}}</strong></label>
                                        <label class="switch">
                                            <input type="checkbox" name="home_page_client_area_05_section_status"  @if(!empty(get_static_option('home_page_client_area_05_section_status'))) checked @endif id="home_page_client_area_05_section_status">
                                            <span class="slider"></span>
                                        </label>
                                    </div>
                                </div>
