                                ...
                                <div class="col-lg-12">
                                    ...
                                    <div class="form-group">
                                     ...
                                     <div class="form-group">
                                        ...
                                        <input type="text" class="form-control"  id="guest" name="guest" value="{{old('guest')}}" placeholder="{{__('Event Guest')}}">
                                    </div>
                                     <div class="form-group">
                                        <label for="guest_position">{{__('Guest Position')}}</label>
                                        <input type="text" class="form-control"  id="guest_position" name="guest_position" value="{{old('organizer')}}" placeholder="{{__('Guest Position')}}">
                                    </div>
                                     <div class="form-group">
                                        <label for="host">{{__('Host')}}</label>
                                        <input type="text" class="form-control"  id="host" name="host" value="{{old('host')}}" placeholder="{{__('Event host')}}">
                                    </div>
                                     <div class="form-group">
                                        <label for="host_position">{{__('Host Position')}}</label>
                                        <input type="text" class="form-control"  id="guest_position" name="host_position" value="{{old('host_position')}}" placeholder="{{__('Host Position')}}">
                                    </div>
                                    <div class="form-group">
