...
class EventsController extends Controller
{
    ...
    public function store_event(Request $request){
        ...
        $slug_check = Events::where(['slug' => $slug])->count();
        $event_slug = $slug_check < 1 ? $slug.'-2' : $slug;
    ...
    public function update_event(Request $request){
        ...
        $slug = !empty($request->slug) ? Str::slug($request->slug) : Str::slug($request->title);
        $slug_check = Events::where(['slug' => $slug])->count();
        $event_slug = $slug_check > 1 ? $slug.'-3' : $slug;
    ...
    public function clone_event(Request $request){
        ...
        Events::create([
            ...
            'documentation_link' => $event_details->documentation_link,
