                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="bulk-delete-wrapper">
                            <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('counterup-delete')): ?>
                                <?php if (isset($component)) { $__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4 = $component; } ?>
...
<?php endif; ?>
                            <?php endif; ?>
                            <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('counterup-create')): ?>
                                <div class="btn-wrapper">
                                    <a data-toggle="modal" class="btn btn-info text-white pull-right mb-4"
                                       data-target="#new_coutnerup_item"><?php echo e(__('New Counterup')); ?></a>
                                </div>
                            <?php endif; ?>
                        </div>
...
<?php endif; ?>
                                        ...
                                        <td><i class="<?php echo e($data->icon); ?>" style="font-size: 40px"></i></td>
...
<?php endif; ?>
                                            <?php endif; ?>
                                            <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('counterup-edit')): ?>
                                                <a href="#"
                                                   data-toggle="modal"
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title"><?php echo e(__('New Counterup Item')); ?></h5>
                    <button type="button" class="close" data-dismiss="modal"><span>×</span></button>
                </div>
                <form action="<?php echo e(route('admin.counterup')); ?>" enctype="multipart/form-data" method="post">
                    <div class="modal-body">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="extra_text" name="extra_text"
                                   placeholder="<?php echo e(__('Extra Text')); ?>">
                        </div>
                    </div>
...
<?php echo $__env->make('backend.admin-master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\ahimsa_baru\@core\resources\views/backend/pages/counterup.blade.php ENDPATH**/ ?>