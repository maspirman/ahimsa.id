                            ...
                            <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('page-create')): ?>
                                <div class="header-title">
                                    <a href="<?php echo e(route('admin.page.new')); ?>"
                                       class="btn btn-primary mt-4 pr-4 pl-4"><?php echo e(__('Add New Page')); ?></a>
                                </div>
                            <?php endif; ?>
                        </div>
...
<?php endif; ?>
                                        ...
                                        <td><?php echo e(($data->title) ?? __('Untitled')); ?></td>
...
<?php endif; ?>
                                            ...
                                            <?php if (isset($component)) { $__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4 = $component; } ?>
<?php $component = $__env->getContainer()->make(Illuminate\View\AnonymousComponent::class, ['view' => 'components.view-icon','data' => ['url' => route('frontend.dynamic.page',[$data->slug,$data->id])]]); ?>
<?php $component->withName('view-icon'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php $component->withAttributes(['url' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(route('frontend.dynamic.page',[$data->slug,$data->id]))]); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4)): ?>
<?php $component = $__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4; ?>
...
<?php echo $__env->make('backend.admin-master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\ahimsa_baru\@core\resources\views/backend/pages/page/index.blade.php ENDPATH**/ ?>