            ...
            <div class="col-lg-12 mt-t">
                <div class="card">
                    <div class="card-body">
                        ...
                        <form action="<?php echo e(route('admin.homeone.counterup.area')); ?>" method="post" enctype="multipart/form-data">
                            <?php echo csrf_field(); ?>
                            <div class="form-group">
                                ...
                                <div class="media-upload-btn-wrapper">
                                    <div class="img-wrap">
                                        <?php $home_page_01_about_us_right_image = get_static_option('home_page_02_coutnerup_background_image'); ?>
                                        <?php echo render_attachment_preview_for_admin($home_page_01_about_us_right_image); ?>

                                    </div>
                                    <input type="hidden" name="home_page_02_coutnerup_background_image" value="<?php echo e($home_page_01_about_us_right_image); ?>">
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('backend.admin-master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\ahimsa_baru\@core\resources\views/backend/pages/home/home-01/counterup.blade.php ENDPATH**/ ?>