...
<div class="page-container">
    ...
    <footer>
        <div class="footer-area footer-wrap">
            ...
            <p class="version">v-<?php echo e(get_static_option('site_script_version','1.2.2')); ?></p>
        </div>
    </footer>
</div>
...
<?php /**PATH C:\xampp\htdocs\ahimsa_baru\@core\resources\views/backend/admin-master.blade.php ENDPATH**/ ?>