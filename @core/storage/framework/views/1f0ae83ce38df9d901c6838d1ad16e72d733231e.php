            ...
            <div class="modal-body">
                ...
                <div class="tab-content">
                    <div class="tab-pane fade show active" id="upload_files" role="tabpanel" >
                        <?php $imageUploadRoute = $imageUploadRoute ?? route('admin.upload.media.file');  ?>
                        <div class="dropzone-form-wrapper">
                            <form action="<?php echo e($imageUploadRoute); ?>" method="post" id="placeholderfForm" class="dropzone" enctype="multipart/form-data">
                                <?php echo csrf_field(); ?>
                                <?php if(isset($userUpload) && $userUpload): ?>
                            ...
                            <div class="main-content-area-wrap">
                                ...
                                <div class="media-uploader-image-info">
                                    ...
                                    <div class="img-info">
                                        ...
                                        <a tabindex="0" class="btn btn-danger btn-xs mb-3 mr-1 media_library_image_delete_btn text-white" style="display: none">
...
</div><?php /**PATH C:\xampp\htdocs\ahimsa_baru\@core\resources\views/components/media/markup.blade.php ENDPATH**/ ?>