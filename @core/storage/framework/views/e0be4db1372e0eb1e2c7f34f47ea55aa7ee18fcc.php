        ...
        <div class="row justify-content-center">
            <div class="col-lg-8 col-sm-11 col-11">
                <div class="section-title section-title-four b-top desktop-center padding-top-25 margin-bottom-55">
                    ...
                    <h2><?php echo e(filter_static_option_value('home_page_02_what_we_do_area_title',$static_field_data)); ?></h2>
                </div>
            </div>
        </div>
        <div class="row">
                    ...
                    <div class="events-flex-contents">
                        <div class="events-date">
                            <div class="events-boxe">
                                <span class="events-title">  <i class="<?php echo e($icon); ?>"></i></span>
                                
                            </div>
                        </div>
                        <div class="events-content">
                            <h3 class="title"><?php echo e($all_title_fields[$loop->index] ?? ''); ?></h3>
                            <p class="content-para" style="text-align: justify;">  <?php echo e($all_description_fields[$loop->index] ?? ''); ?> </p>
                                              </div>
                    </div>
                </div>
            </div>
            ...
            <div class="col-xl-5 col-lg-7">
                <div class="help-and-support-left">
                    <div class="section-title margin-bottom-35">
                        ...
                        <div class="description" style="color: green;"><?php echo filter_static_option_value('home_page_01_about_us_description',$static_field_data); ?></div>
                    </div>
                    <div class="content">
                        <?php
...
<?php }; ?>
 <?php if(get_static_option('home_page_recent_cause_section_status')): ?>
        <div class="row justify-content-center">
            <div class="col-lg-8 col-sm-11 col-11">
                <div class="section-title b-top desktop-center padding-top-25 margin-bottom-55">
                    <span><?php echo e(filter_static_option_value('home_page_01_recent_cause_area_subtitle',$static_field_data)); ?></span>
                    <h2 class="title"><?php echo render_colored_text(filter_static_option_value('home_page_01_recent_cause_area_title',$static_field_data)); ?></h2>
                </div>
            </div>
        </div>
        <div class="row">
            ...
            <div class="col-lg-12">
                <div class="attend-title-content margin-bottom-50">
                    <div class="section-title desktop-left">
                        ...
                        <h1><?php echo render_colored_text(filter_static_option_value('home_page_01_latest_event_title',$static_field_data)); ?></h3>
                    </div>
...
<?php endif; ?>
        ...
        <div class="row justify-content-center">
            <div class="col-lg-8 col-sm-11 col-11">
                <div class="section-title b-top desktop-center padding-top-30 margin-bottom-55">
                    <span>Our Colaborate</span>
                    <h2 class="">Kami Telah Berkolaborasi Dengan 100+
Perusahaan Dan Organisasi</h2>
                </div>
            </div>
        </div>
        <div class="row">
        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="section-title desktop-center margin-bottom-50">
                    ...
                    <h4 class=""><?php echo render_colored_text(filter_static_option_value('home_page_01_latest_news_title',$static_field_data)); ?></h3>
                </div>
            </div>
        </div>
        <div class="row">
...
<!-- blog area end -->
 <?php endif; ?><?php /**PATH C:\xampp\htdocs\ahimsa_baru\@core\resources\views/frontend/home-pages/home-03.blade.php ENDPATH**/ ?>