                           ...
                           <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('blog-category-create')): ?>
                                <div class="btn-wrapper">
                                    <a data-toggle="modal" data-target="#new_category_modal"
                                       class="btn btn-info text-white pull-right mb-3"><?php echo e(__('New Category')); ?></a>
                                </div>
                            <?php endif; ?>
                        </div>
    ...
    <div class="modal fade" id="new_category_modal" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <form action="<?php echo e(route('admin.blog.category')); ?>" method="post">
...
<?php echo $__env->make('backend.admin-master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\ahimsa_baru\@core\resources\views/backend/blog/category.blade.php ENDPATH**/ ?>